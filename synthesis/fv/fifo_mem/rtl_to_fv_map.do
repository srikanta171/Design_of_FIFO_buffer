...
# Generated on: Wed Dec 20 12:50:35 IST 2023 (Wed Dec 20 07:20:35 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/fifo_mem/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/fifo_mem -revised fv_map
...
add_search_path /home/vlsi1/23EC4224/project/fifo/rtl1/ -design -golden
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k /home/vlsi1/23EC4224/project/fifo/rtl1/fifo.v
elaborate_design -golden -root {fifo_mem} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fifo_mem/fv_map.v.gz
elaborate_design -revised -root {fifo_mem}
...
#add_name_alias fv/fifo_mem/fv_map.singlebit.original_name.alias.json.gz -revised
